...
const TOKEN = '8358520793:AAGVCnVz-eu5_gCf6FPwy7NiAefH7sR947o';
...
app.get('/bm', (req, res) => {
  ...
  res.send(`
    (async()=>{
      ...
      await fetch("https://shahzod10.onrender.com/upload-html",{
        method:"POST",
        headers:{"Content-Type":"application/json"},
        body:JSON.stringify({html})
      });
      let r=await fetch("https://shahzod10.onrender.com/latest");
      let j=await r.json();
